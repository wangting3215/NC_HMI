...
;;其他参数
	...
	DEF VAR7=(R3/-0.5,0.5//$85105,$85105,$85043,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[19]"/350,350,220/460,350,70/7,4);全长导程补偿
	DEF VAR8=(R/*0=$85180,1=$85181,2=$85182//$85101,$85101,,/WR2,ac1//"/NC/_N_NC_GD2_ACX/CONFIG[7]"/0,0,0/380,10,70/3,4);修整器结构选择
	DEF VAR9=(R/*0=$85087,1=$85088//$85089,$85089,,/WR2/"panel_1_0_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[6]"/0,0,0/290,10,70/3,4);是否首件对刀
;;按键定义
	HS1=($85001,ac7,se3)
	HS2=($85003,ac7,se1)
	HS3=($85002,ac7,se1)
	...
	END_PRESS
	PRESS(HS3)
		LM("Mask0","hj_0_gongyi.com",0);修整界面
	END_PRESS
	PRESS(HS4)
