...
//M(Mask0/$85711/"panel_2_2_chs.png"/)
	;;修整参数
		...
		DEF GUANCHA_0=(R///$85322,$85321,,$85043/WR2,ac3/"panel_2_3_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[1]"/325,310,110/440,310,110/7,4);观察参数(当前砂轮直径对应的修整接触点坐标)
	...
	;;滚轮参数
		...
		DEF VAR_GL1=(R///$85626,$85602,,$85043/WR2,ac3/"panel_2_0_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[25]"/40,270,110/120,270,110/7,4);手动对出的新砂轮触碰滚轮时X轴坐标
...
//M(Mask2/$85711/"panel_2_8_chs.png"/)
	...
	;;滚轮参数
		...
		DEF VAR_GL1=(R///$85610,$85610,,$85043/WR4,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[6]"/10,270,50/110,270,110/7,4);修整轮左侧圆弧半径
		DEF VAR_GL2=(R///$85611,$85611,,$85043/WR4,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[7]"/10,290,50/110,290,110/7,4);修整轮右侧圆弧半径
		DEF VAR_GL1_1=(R///$85610,$85610,,$85043/WR4,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[7]"/10,270,50/110,270,110/7,4);修整轮左侧圆弧半径
		DEF VAR_GL2_1=(R///$85611,$85611,,$85043/WR4,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[6]"/10,290,50/110,290,110/7,4);修整轮右侧圆弧半径
	...
	;;CHANGE事件
		...
		END_SUB
		SUB(UP3)
			VAR_SL9.VAL=2*(VAR_JZ1.VAL-GUANCHA_0);计算当前砂轮直径
		END_SUB
		SUB(UP4)
			IF VAR_GL3.VAL<=0
				VAR_GL1.WR=4
